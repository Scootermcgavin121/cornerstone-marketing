...
const socials = [
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/profile.php?id=1010173695518503",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/cornerstonebuildersoftware",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-5 gap-12">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              <img src="/logo.png" alt="Cornerstone" className="w-9 h-9 object-contain" />
              <span className="font-bold text-lg text-white">Cornerstone</span>
            </div>
        ...
        <div className="mt-12 pt-8 border-t border-slate-800/50 text-center">
          <p className="text-sm text-slate-500">
            © 2026 Cornerstone Builder Software. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
