...
const features = [
  ...
  },
  {
    ...
    desc: "When structural options are locked in the sales pipeline, the system auto-generates a full home budget from floorplan takeoffs — ~97 budget lines with elevation adders and option pricing. Zero manual entry.",
    badge: "Automated",
  },
  {
    icon: (
    ...
    title: "Structural Options Pricing",
    desc: "12+ structural options per floorplan — Bonus Room ($42K), Finished Basement ($112.5K), 8' Doors ($7.2K), Irrigation Well ($9.75K), and more. Cost and retail pricing tracked separately.",
    badge: "Per Floorplan",
  },
  {
    icon: (
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <AnimateOnScroll className="text-center mb-20">
          <div className="inline-flex items-center gap-3 px-6 py-3 rounded-2xl bg-slate-900/80 border border-slate-800/50">
            ...
            <span className="text-sm text-slate-400">$179.98/mo total with scheduling</span>
          </div>
        </AnimateOnScroll>
        ...
        <AnimateOnScroll className="mt-24">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-400 max-w-2xl mx-auto">
              BuilderTrend starts at $499/month and doesn&apos;t even include purchasing. We include everything.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <div className="relative p-8 rounded-2xl bg-slate-900/50 border border-cyan-500/30 ring-1 ring-cyan-500/10">
              ...
              <div className="space-y-4">
                <div className="flex items-baseline gap-2">
                  <span className="text-4xl font-extrabold text-cyan-400">$179.98</span>
                  <span className="text-slate-400">/month</span>
                </div>
          ...
          <div className="text-center mt-8">
            <p className="text-lg text-slate-400">
              That&apos;s{" "}
              <span className="text-2xl font-extrabold text-emerald-400">$3,800+</span>{" "}
