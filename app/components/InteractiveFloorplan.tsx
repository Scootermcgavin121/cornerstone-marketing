                ...
                <div className="mt-6 rounded-2xl border border-emerald-500/20 bg-emerald-500/10 p-5">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      ...
                      <h4 className="mt-1 text-xl font-bold text-white">The Cypress — Personalized Plan</h4>
                    </div>
    ...
    <svg viewBox="0 0 900 560" role="img" aria-label="Interactive sample floorplan" className={`w-full ${compact ? "h-auto" : "min-h-[340px]"}`}>
      ...
      {active("screened_porch") ? (
        <g id="a-on-screened_porch-off-morning_room" className="on">
          <text x="455" y="30" textAnchor="middle" fill="#0369a1" fontSize="13" fontWeight="800">Screened Porch selected — Morning Room hidden</text>
        </g>
      ) : null}
      {active("morning_room") ? (
        <g id="a-on-morning_room-off-screened_porch" className="on">
          <text x="485" y="30" textAnchor="middle" fill="#15803d" fontSize="13" fontWeight="800">Morning Room selected — Screened Porch hidden</text>
        </g>
      ) : null}
